...
//#define WITH_LATENTCLUSTER	//if defined: distributes samples over cluster machines
...
int main(int argc, char** argv) {
	...
	DH_TYPE::SPParameters SPSettings;
	...
	LatentStructuredPrediction<NUM_TYPE,SP_TYPE,DH_TYPE> LSP(&SPSettings);

	std::vector<NUM_TYPE> w(LSP.GetNumFeatures(), NUM_TYPE(1.0));
	if(weightFile!=NULL) {
